            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        <select name="cat_id">
                            ...
                            <option value="{{$category->cate_pid}}">{{$category->_cate_name}}</option>
                            @endforeach
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <script id="editor" type="text/plain" name="art_content" style="width:860px; height:500px; font-weight: bold; "></script>
